    ...
    def linebaru(self, linein):
        ...
        for i in range(len(linein)):
            if linein[i][0] == linein[i][2]:
                self.line2.append(self.canvas.create_oval(linein[i][0], linein[i][1], linein[i][2]+10, linein[i][3]+10,fill = "Black", tags="line"))
            else:    
                self.line2.append(self.canvas.create_line(linein[i][0], linein[i][1], linein[i][2], linein[i][3], tags="line"))
            #print(self.line2)
